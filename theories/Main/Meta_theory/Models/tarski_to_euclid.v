...
Proof.
eapply (Build_euclidean_neutral Tpoint Tcircle tarski_axioms.Cong Axioms.Definitions.BetS (* InCirc OnCirc OutCirc*) tarski_axioms.PA tarski_axioms.PB tarski_axioms.PC CI).
