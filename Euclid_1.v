...
assert (H : Cong W R W' R' /\ Cong W R' W' R /\ Par W R W' R' /\ Par W R' W' R).
  {
  do 3 (split; try apply l7_13 with X; try apply l12_17 with X; Midpoint);
...
destruct H as [HCong3 [HCong4 [HPar4 HPar5]]].
...
destruct H as [HCong5 [HCong6 [HPar6 HPar7]]].
assert (X = X'); treat_equalities.
  {
  assert (Col X X' Y).
    {
