...
(**    All these properties are known to be equivalent in an arbitrary Hilbert plane
  (Tarski_2D) as shown by Strommer, and they follow from the axiom of Dedekind,
  but we don't have formalized the proof yet. 
 
  We have the following proofs.
  We have two equivalent variants of the circle-circle continuity axiom.
  We have three equivalent variants of the line-circle continuity axiom.
*)
...
Proof.
  ...
  - intros Hsc A B U V P HCol HUV HBet.
    ...
    destruct (Hsc A B P Q) as [Z [HZ1 HZ2]]; trivial.
      apply (cong_preserves_le Q Q0 Q A); Cong.
  ...
  { intros Hcc A B C D P Q.
    ...
    subst C.
      ...
      assert (Cong A B A D).
        ...
        apply (cong_preserves_le A B A Q); Cong.
        apply (cong_preserves_le A P A B); Cong.
    ...
    - apply (lt__nle A B A Q); trivial.
      apply cong_preserves_le with A Q A Z1; Cong.
      apply triangle_inequality with C; trivial.
      apply cong_transitivity with C D; Cong.
    - apply (lt__nle A P A B); trivial.
      apply cong_preserves_le with A Z1 A P; Cong.
